...
This version finally works on all browsers, mobile and desktop! However, on mobile (android chrome and ios safari) the intertial scrolling/momentum is interrupted and halts on loading (either end).:
